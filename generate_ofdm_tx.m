function [tx_data, tx_payload_vec, tx_syms]=generate_ofdm_tx(tx_data,pilots, MOD_ORDER, number_of_bits, N_SC, CP_LEN, SC_IND_DATA, SC_IND_PILOTS, N_OFDM_SYMS, trellis_end_length, DISP_GRAPH)
